...
struct PermissionCheckerView: View {
    ...
    private var expectedEntitlements: [EntitlementInfo] {
        [
            ...
            EntitlementInfo(key: "com.apple.private.security.get-task-allow", desc: "调试附加权限"),
            EntitlementInfo(key: "com.apple.coremedia.jit", desc: "JIT 编译权限"),
            EntitlementInfo(key: "com.apple.security.disable-library-validation", desc: "禁用库验证"),
            ...
            EntitlementInfo(key: "platform-application", desc: "平台应用标识"),
            ...
            EntitlementInfo(key: "get-task-allow", desc: "允许调试附加"),
            EntitlementInfo(key: "com.apple.developer.kernel.increased-memory-limit", desc: "扩展内存限制"),
            EntitlementInfo(key: "com.apple.developer.kernel.extended-virtual-addressing", desc: "扩展虚拟地址"),
            EntitlementInfo(key: "com.apple.security.cs.allow-dyld-environment-variables", desc: "DYLD 环境变量"),
            EntitlementInfo(key: "com.apple.security.cs.allow-jit", desc: "允许 JIT"),
            EntitlementInfo(key: "com.apple.security.cs.disable-executable-page-protection", desc: "禁用页保护"),
